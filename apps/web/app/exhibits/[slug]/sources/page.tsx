...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <PublicSection
    ...
    intro={demo ? { en: "The public register prioritizes source identity, location, rights, and contribution over long copied excerpts.", zh: "公共登记册优先展示来源身份、位置、权利和研究贡献，而不是大段复制原文。" } : { en: "A screened, public-safe research queue. Filter thirty prioritized records while keeping discovery rank, verified record, and historical truth separate.", zh: "经过筛选、适合公开展示的研究队列。可以筛选三十条优先记录，同时明确区分发现排序、记录核验与历史真实性。" }}
